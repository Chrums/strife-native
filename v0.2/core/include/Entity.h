    ...
    namespace Core {
        ...
        private:
            ...
            public:
            	...
            	//IIterator<std::pair<const Entity, Component&>> find(const std::type_index type) const;
				...
				// Iterator find() const {
				// 	const std::type_index type(typeid(C));
				// 	IIterator<std::pair<const Entity, Component&>> iterator = find(type);
				// 	return static_cast<IIterator<std::pair<const Entity, Component&>>>(iterator);
				// }
